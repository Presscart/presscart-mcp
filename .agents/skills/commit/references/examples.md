...
**Why it fails**: The user has a standing global rule that commits are authored solely by them. Never add Claude, Anthropic, Codex, or OpenAI attribution trailers.
